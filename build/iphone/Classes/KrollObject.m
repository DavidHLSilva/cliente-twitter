...
//@interface cliente_twitter_uamiObject : NSObject
//@end

@interface cliente_twitter_uamiObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
  ...
  if (o) {
    ...
    if ([o isKindOfClass:[cliente_twitter_uamiObject class]]) {
      for (NSString *key in [[(cliente_twitter_uamiObject *)o modules] allKeys]) {
