...
@interface cliente_twitter_uamiObject : KrollCoverageObject {
#else
@interface cliente_twitter_uamiObject : KrollObject {
#endif
  @private
...
extern NSString *cliente_twitter_uami$ModuleRequireFormat;
...
@interface KrollBridge : Bridge <TiEvaluator, KrollDelegate> {
  ...
  cliente_twitter_uamiObject *_cliente_twitter_uami;
  KrollObject *console;
  BOOL shutdown;
