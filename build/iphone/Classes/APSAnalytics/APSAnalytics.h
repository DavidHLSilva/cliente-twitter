 ...
 * to send analytic data that can be viewed on the cliente_twitter_uami Dashboard.
 *
 * For information on getting started with cliente_twitter_uami Platform Services,
 * see [cliente_twitter_uami Platform Services for iOS](http://bit.ly/1kqteQS).
 */
