...
static NSString *const kcliente_twitter_uamiJavascript = @"Ti.App={};Ti.API={};Ti.App._listeners={};Ti.App._listener_id=1;Ti.App.id=Ti.appId;Ti.App._xhr=XMLHttpRequest;"
...
- (NSString *)_cliente_twitter_uamiInjection
{
  if (pageToken == nil) {
  ...
  [html appendString:kcliente_twitter_uamiJavascript];
...
+ (NSString *)content:(NSString *)content withInjection:(NSString *)injection
{
  ...
  // attempt to make well-formed HTML and inject in our cliente_twitter_uami bridge code
             ...
             baseURL:(NSURL *)baseURL
{
  ...
  content = [[self class] content:content withInjection:[self _cliente_twitter_uamiInjection]];
            ...
            mimeType:(NSString *)mimeType
{
  ...
  [request setValue:[NSString stringWithFormat:@"%lu", (localId++)] forHTTPHeaderField:@"X-cliente_twitter_uami-Local-Id"];
...
- (BOOL)webView:(UIWebView *)webView shouldStartLoadWithRequest:(NSURLRequest *)request navigationType:(UIWebViewNavigationType)navigationType
{
  ...
  if ([scheme hasPrefix:@"http"] || [scheme isEqualToString:@"ftp"]
    ...
    if ([scheme isEqualToString:@"file"] || [scheme isEqualToString:@"app"]) {
      [LocalProtocolHandler setContentInjection:[self _cliente_twitter_uamiInjection]];
    }
    return YES;
  }
