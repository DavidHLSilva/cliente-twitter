...
/**
 The base class for all cliente_twitter_uami modules
 */
...
/**
 cliente_twitter_uami Platform calls this method on startup.
 */
- (void)startup;

/**
 cliente_twitter_uami Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
- (void)shutdown:(id)sender;

/**
 cliente_twitter_uami Platform calls this method on suspend.
 @param sender The sender of the event.
 */
- (void)suspend:(id)sender;

/**
 cliente_twitter_uami Platform calls this method on entering background.
 @param sender The sender of the event.
 */
- (void)paused:(id)sender;

/**
 cliente_twitter_uami Platform calls this method on resume.
 @param sender The sender of the event.
 */
