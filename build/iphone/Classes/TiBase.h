...
// in simulator we redefine to format for cliente_twitter_uami Developer console
...
#define DEFINE_EXCEPTIONS                                                                                      \
  ...
  {                                                                                                            \
    NSString *exceptionName = [@"org.cliente_twitter_uami." stringByAppendingString:NSStringFromClass([self class])];  \
    TiExceptionThrowWithNameAndReason(exceptionName, reason, subreason, location);                             \
  }                                                                                                            \
                                                                                                               \
  +(void)throwException : (NSString *)reason subreason : (NSString *)subreason location : (NSString *)location \
  {                                                                                                            \
    NSString *exceptionName = @"org.cliente_twitter_uami";                                                             \
    TiExceptionThrowWithNameAndReason(exceptionName, reason, subreason, location);                             \
  }
...
enum {
  UIcliente_twitter_uamiNativeItemNone = -1,
  UIcliente_twitter_uamiNativeItemSpinner = -2,
  UIcliente_twitter_uamiNativeItemProgressBar = -3,

  UIcliente_twitter_uamiNativeItemSlider = -4,
  UIcliente_twitter_uamiNativeItemSwitch = -5,
  UIcliente_twitter_uamiNativeItemMultiButton = -6,
  UIcliente_twitter_uamiNativeItemSegmented = -7,

  UIcliente_twitter_uamiNativeItemTextView = -8,
  UIcliente_twitter_uamiNativeItemTextField = -9,
  UIcliente_twitter_uamiNativeItemSearchBar = -10,

  UIcliente_twitter_uamiNativeItemPicker = -11,
  UIcliente_twitter_uamiNativeItemDatePicker = -12,

  UIcliente_twitter_uamiNativeItemInfoLight = -13,
  UIcliente_twitter_uamiNativeItemInfoDark = -14,

  UIcliente_twitter_uamiNativeItemDisclosure = -15,

  UIcliente_twitter_uamiNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all cliente_twitter_uami instances of
