...
//Rare exceptions to indicate a bug in the _cliente_twitter_uami code (Eg, function that a subclass should have implemented)
...
/**
 The base class for cliente_twitter_uami proxies.
 */
