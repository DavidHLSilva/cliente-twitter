...
- (TiBlob *)toImage:(id)args
{
  ...
  TiThreadPerformOnMainThread(^{
    ...
    if (callback != nil) {
      DebugLog(@"[DEBUG] Since cliente_twitter_uami SDK 7.0.0, the toImage callback returns a single blob on iOS to match the Android / Windows behavior.");
      DebugLog(@"[DEBUG] Please migrate your code in case you still use the old behavior. This debug-log will be removed in cliente_twitter_uami SDK 8.0.0");
