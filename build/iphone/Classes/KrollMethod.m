...
- (id)call:(NSArray *)args
{
  ...
  if (_methodSignature == nil) {
    @throw [NSException exceptionWithName:@"org.cliente_twitter_uami.kroll" reason:[NSString stringWithFormat:@"invalid method '%@'", NSStringFromSelector(selector)] userInfo:nil];
  }
  id arg1 = nil;
  id arg2 = nil;
