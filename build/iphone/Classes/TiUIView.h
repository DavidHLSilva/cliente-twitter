...
/**
 Base class for all cliente_twitter_uami views.
 @see TiViewProxy
 */
#ifdef TI_USE_AUTOLAYOUT
...
/**
 Whether or not a view not normally picked up by the cliente_twitter_uami view hierarchy (such as wrapped iOS UIViews) was touched.
